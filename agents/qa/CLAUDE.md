...
> ⚠️ **DEPRECATO** — Questo agente è stato sostituito dal **Delivery Tracker Agent**
> (`agents/delivery_tracker/CLAUDE.md`).
>
> Il QA Agent faceva parte della vecchia pipeline di sviluppo software.
> Con il pivot verso servizi (consulenza, web design, manutenzione digitale),
> il tracciamento qualità e milestone è gestito dal Delivery Tracker.
>
